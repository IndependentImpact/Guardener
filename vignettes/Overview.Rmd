...
AT2 <- Glogin(un = "Nova Institute", pw = "nova1994inst", baseurl = "http://datadudes.xyz:3000")
AT2 <- AT2$accessToken
dropbase <- "http://datadudes.xyz:3000/"
```
...
dfPolicies2 <- GgetPolicies(AT, baseurl = dropbase, returndf = TRUE)
...
```{r}
blocks <- GgetPolicyBlocks(accessToken = AT, policyId = dfPolicies$id)
```
