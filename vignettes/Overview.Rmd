...
You need to have a username and password. For the defaults, Uuse usethis::edit_r_environ() to edit the R environment. These value are be retrived with Sys.getenv("guardianUN2") and Sys.getenv("guardianPW2")
...
AT <- Glogin(un = Sys.getenv("guardianUN2"), 
              pw = Sys.getenv("guardianPW2"), 
              baseurl = dropbase)
AT <- AT$accessToken
